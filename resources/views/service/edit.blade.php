...
<div class="row affix-row">
    ...
    <div class="affix-content">
        ...
        <form class="pt-4" method="POST" action="{{ route('service.update',['officer_id'=>$officerObj->id,'id'=>$record->id]) }}" enctype='multipart/form-data'>
            @csrf
            ...
            <div class="row">
                ...
                name="is_active" id="is_active" style="visibility: visible !important;"
            ...
            <div class="row">
                <div class="col-lg-4 col-12 col-md-4 ">
                    <div class="form-group">
                        ...
                        value="{{old('notification_date',$record->notification_date)}}" name="notification_date" id="notification_date">
                ...
                <div class="col-lg-4 col-12 col-md-4 ">
                    <div class="form-group">
                        ...
                        value="{{old('from_date',$record->from_date)}}" name="from_date" id="from_date">
                ...
                <div class="col-lg-4 col-12 col-md-4">
                    <div class="form-group">
                        ...
                        value="{{old('to_date',$record->to_date)}}" name="to_date" id="to_date">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12 col-md-4">
                    <div class="form-group">
                        ...
                        <?php $post_id = old('post_id',$record->post_id); ?>
                ...
                <div class="col-lg-6 col-12 col-md-4">
                    <div class="form-group">
                        ...
                        value="{{old('specialization',$record->specialization)}}" name="specialization" id="specialization">
            ...
            <div class="row">
                <div class="col-lg-4 col-12 col-md-4 ">
                    <div class="form-group">
                        ...
                        <?php $grade_id = old('grade_id',$record->grade_id); ?>
                ...
                <div class="col-lg-4 col-12 col-md-4">
                    <div class="form-group">
                        ...
                        <?php $province_id = old('province_id',$record->province_id); ?>
                ...
                <div class="col-lg-4 col-12 col-md-4">
                    <div class="form-group">
                        ...
                        <?php $ministry_id = old('ministry_id',$record->ministry_id); ?>
            ...
            <div class="row">
                <div class="col-lg-4 col-12 col-md-4 ">
                    <div class="form-group">
                        ...
                        <?php $division_id = old('division_id',$record->division_id); ?>
                ...
                <div class="col-lg-4 col-12 col-md-4">
                    <div class="form-group">
                        ...
                        <?php $department_id = old('department_id',$record->department_id); ?>
                ...
                <div class="col-lg-4 col-12 col-md-4">
                    <div class="form-group">
                        ...
                        <?php $district_id = old('district_id',$record->district_id); ?>
            ...
            <div class="row">
                <div class="col-lg-4 col-12 col-md-4 ">
                    <div class="form-group">
                        ...
                        value="{{old('city',$record->city)}}" name="city" id="city">
                ...
                <div class="col-lg-4 col-12 col-md-4">
                    <div class="form-group">
                        ...
                        <?php $posting_type_id = old('posting_type_id',$record->posting_type_id); ?>
            ...
            <div class="row">
                <div class="col-lg-6 col-12 col-md-4">
                    <div class="form-group">
                        ...
                        rows="4" spellcheck="false">{{old('further_detail',$record->further_detail)}}</textarea>
                ...
                <div class="col-lg-6 col-12 col-md-4">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="post_list" name="post_list" cols="30"
                                  rows="4" spellcheck="false">{{old('post_list',$record->post_list)}}</textarea>
                ...
                <div class="col-lg-6 col-12 col-md-4">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="orgnization_list" name="orgnization_list" cols="30"
                                  rows="4" spellcheck="false">{{old('orgnization_list',$record->orgnization_list)}}</textarea>
