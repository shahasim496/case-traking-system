...
<div class="row affix-row form-main">
    ...
    <div class="affix-content">
        ...
        <form class="pt-4" method="POST" action="{{ route('achievement.store',$officerObj->id) }}" enctype='multipart/form-data'>
            @csrf
            ...
            <div class="row">
                <div class="col-lg-6 col-12 col-md-6 ">
                    <div class="form-group">
                        ...
                        value="{{old('award_name')}}" name="award_name" id="award_name">
                ...
                <div class="col-lg-6 col-12 col-md-6 ">
                    <div class="form-group">
                        ...
                        value="{{old('award_authority')}}" name="award_authority" id="award_authority">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12 col-md-6 ">
                    <div class="form-group">
                        ...
                        value="{{old('date')}}" name="date" id="landline_number">
                        @if ($errors->has('date'))
                ...
                <div class="col-lg-6 col-12 col-md-6 ">
                    <div class="form-group">
                        ...
                        rows="4" spellcheck="false">{{old('decription')}}</textarea>
