        ...
        <div class="col-lg-10">
            <div class="card shadow-sm">
                <div class="card-header text-white" style="background-color: #00349C;">
                    <h4 class="mb-0">
                        <i class="fa fa-gavel mr-2"></i>Edit Court 
                    </h4>
                </div>
                <div class="card-body p-4">
                    @include('components.toaster')
                    
                    <form method="POST" action="{{ route('courts.update', $court->id) }}" id="courtForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <h5 class="border-bottom pb-2 mb-3" style="color: #00349C;">
                                    <i class="fa fa-info-circle mr-2"></i>Court Information
                                </h5>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="court_type" 
                                        ...
                                        <option value="High Court" {{ old('court_type', $court->court_type) == 'High Court' ? 'selected' : '' }}>High Court</option>
                                        <option value="Supreme Court" {{ old('court_type', $court->court_type) == 'Supreme Court' ? 'selected' : '' }}>Supreme Court</option>
                                        <option value="Session Court" {{ old('court_type', $court->court_type) == 'Session Court' ? 'selected' : '' }}>Session Court</option>
                                    </select>
                                    @error('court_type')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex justify-content-end">
                                    <div>
                                        <a href="{{ route('courts') }}" class="btn btn-outline-secondary btn-lg mr-2">
                                            <i class="fa fa-times mr-1"></i>Cancel
                                        </a>
                                       
                                        <button type="submit" class="btn btn-lg" style="background-color: #00349C; color: white;">
                                            <i class="fa fa-save mr-1"></i>Update Court
                                        </button>
                                    </div>
                                </div>
                            </div>
