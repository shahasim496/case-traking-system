                        ...
                        <div class="col-lg-8 col-md-6 mb-3 mb-md-0">
                            <div class="search-container">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="searchInput" class="form-control border-left-0" placeholder="Search designations by name...">
...
$(document).ready(function() {
    ...
    $('.delete-btn').on('click', function () {
        var id = $(this).data('id');
        var name = $(this).data('name') || 'this designation';
    ...
    function filterTable(searchTerm) {
        $('#designationsTable tbody tr').each(function() {
            var designationName = $(this).find('td:eq(1)').text().toLowerCase();
            var description = $(this).find('td:eq(2)').text().toLowerCase();
            if (designationName.indexOf(searchTerm) > -1 || description.indexOf(searchTerm) > -1) {
                $(this).show();
            } else {
                $(this).hide();
            }
    ...
    function exportToPDF() {
        ...
        var data = [];
        $('#designationsTable tbody tr:visible').each(function(index) {
            var designationName = $(this).find('td:eq(1)').text();
        ...
        var headers = ['#', 'Designation Name', 'Description'];
        ...
        doc.autoTable({
            ...
            columnStyles: {
                0: { cellWidth: 20 }, // #
                1: { cellWidth: 60 }, // Designation Name
