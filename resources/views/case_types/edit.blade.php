        ...
        <div class="col-lg-10">
            <div class="card shadow-sm">
                <div class="card-header text-white" style="background-color: #00349C;">
                    <h4 class="mb-0">
                        <i class="fa fa-gavel mr-2"></i>Edit Case Type 
                    </h4>
                </div>
                <div class="card-body p-4">
                    @include('components.toaster')
                    
                    <form method="POST" action="{{ route('case_types.update', $caseType->id) }}" id="caseTypeForm">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" 
                                              ...
                                              rows="4" 
                                              placeholder="Enter case type description">{{ old('description', $caseType->description) }}</textarea>
                                    @error('description')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="d-flex justify-content-end">
                                    <div>
                                        ...
                                        <button type="submit" class="btn btn-lg" style="background-color: #00349C; color: white;">
                                            <i class="fa fa-save mr-1"></i>Update Case Type
                                        </button>
                                    </div>
                                </div>
                            </div>
