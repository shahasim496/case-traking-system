            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body p-4">
                        ...
                        <div class="col-lg-8 col-md-6 mb-3 mb-md-0">
                            <div class="search-container">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="searchInput" class="form-control border-left-0" placeholder="Search departments by name or description...">
                    ...
                    <div class="d-flex justify-content-center">
                        {{ $departments->appends(['status' => request('status'), 'per_page' => request('per_page')])->links('pagination::bootstrap-4') }}
                    </div>
                </div>
            </div>
        </div>
...
$(document).ready(function() {
    ...
    function performSearch() {
        ...
        var table = $('#departmentsTable tbody');
        ...
        if (visibleCount === 0 && searchTerm !== '') {
            if (table.find('.no-results').length === 0) {
                table.append('<tr class="no-results"><td colspan="4" class="text-center text-muted">No departments found matching your search.</td></tr>');
            }
        } else {
    ...
    function updateRowNumbers() {
        var visibleRows = $('#departmentsTable tbody tr:visible:not(.no-results)');
