        ...
        <div class="affix-content h-100">
            ...
            <form class="pt-4" method="POST" action="" enctype='multipart/form-data'>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="" class="label-font">Training Type</label>
                            <select data-placeholder="Select Cadre" data-allow-clear="1" name="training_type_id" id="training_type_id">
                                @foreach($training_types as $gs=>$training)
...
<script>
    ...
    table = $('#table_id').DataTable({
        ...
        ajax: {
            url: "{{ route('report.getTrainings') }}",
            data: function(d) {
                d.training_type_id = training_type_id;
                d.to_date = to_date;
