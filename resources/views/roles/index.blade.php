        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header text-white d-flex justify-content-between align-items-center" style="background-color: #00349C;">
                    <h4 class="mb-0">
                    <i class="fa fa-users mr-2"></i>Manage Roles
                    </h4>
                    @can('create role')
                        ...
                        <div class="col-lg-8 col-md-6 mb-3 mb-md-0">
                            <div class="search-container">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="searchInput" class="form-control border-left-0" placeholder="Search roles by name...">
...
$(document).ready(function() {
    ...
    function exportToExcel() {
        ...
        link.download = 'roles_export.xls';
    ...
    function exportToPDF() {
        ...
        doc.text('Roles Report', 105, 20, { align: 'center' });
        ...
        doc.autoTable({
            ...
            columnStyles: {
                0: { cellWidth: 20 }, // #
                1: { cellWidth: 70 }, // Role Name
            },
            didDrawPage: function(data) {
                // Add footer
                doc.setFontSize(10);
                doc.setTextColor(100, 100, 100);
                doc.text('Total Roles: ' + data.length, 105, doc.internal.pageSize.height - 10, { align: 'center' });
            }
        });
