        ...
        <div class="col-lg-10">
            <div class="card shadow-sm">
                <div class="card-header text-white" style="background-color: #00349C;">
                    <h4 class="mb-0">
                        <i class="fa fa-users mr-2"></i>Create New Role  
                    </h4>
                </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <h5 class="border-bottom pb-2 mb-3" style="color: #00349C;">
                                    <i class="fa fa-info-circle mr-2"></i>Role Information
                                </h5>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex justify-content-end">
                                    <div>
                                        <a href="{{ route('roles') }}" class="btn btn-outline-secondary btn-lg mr-2">
                                            <i class="fa fa-times mr-1"></i>Cancel
                                        </a>
                                       
                                        <button type="submit" class="btn btn-lg" style="background-color: #00349C; color: white;">
                                            <i class="fa fa-save mr-1"></i>Create Role
                                        </button>
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function() {
    ...
    // Role name validation - only allow letters, numbers, spaces, and hyphens
