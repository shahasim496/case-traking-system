...
account {{Auth::user()->email}}. Please enter
verification code below. </p>
            </div>
           <form class="form-signin"method="POST" action="{{ route('user.verifyUserCode') }}">
            @csrf
        ...
        <input type="text" id="code4" name="code4" class="form-control" maxlength="1" required>
                ...
                <div class="row">
                    <div class="col-lg-12 text-center mt-2 reg-now">
                        <p>Don't have an account? <a href="{{route('user.resendCode')}}">Send Again</a></p>
                    </div>
