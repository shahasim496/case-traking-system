...
@section('breadcrumb','Add Officer')
...
<div class="row affix-row">
    ...
    <div class="affix-content">
        ...
        <form class="pt-4" method="POST" action="{{ route('user.storeOfficer') }}" enctype='multipart/form-data'>
            @csrf
            <div class="row">
                ...
                @php
                $group_service_id = old('group_service_id');
                @endphp
                ...
                placeholder="0000 - 0000 000" value="{{old('phone')}}">
                @if ($errors->has('phone'))
                ...
                <input type="text" id="password" name="password" placeholder="Type Password" class="form-control mb-3" required="" >
                ...
                <input type="text" id="password_confirmation" name="password_confirmation" placeholder="Re-type Password" class="form-control mb-3" required="" >
                ...
                placeholder="Type your designation" value="{{old('designation')}}">
