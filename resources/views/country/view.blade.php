...
@section('breadcrumb','View Country')
@section('edit','Edit')
@section('link',route('country.edit',['id'=>$record->id]))
...
@section('content')
    ...
    <div class="row affix-row form-main">
        ...
        <div class="col-lg-12 col-md-12 col-12 mb-3">
            ...
            <!-- <a href="{{route('country.delete',['id'=>$record->id])}}"
                    onClick="return deleteR({{$record->id}});"
                    id="delete_{{$record->id}}" class="btn btn-danger">Delete</a> -->
                <a href="{{route('country',['id'=>$record->id])}}" class="btn btn-secondary">Back</a>
            </div>
